...
const GITHUB_CONFIG = {
    ...
    // Production GitHub OAuth App callback: https://bloomly.co.ke/api/auth/callback/github
    // Keep the host aligned with NEXTAUTH_URL or the deployment's public site URL.
